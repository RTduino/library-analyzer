...
# 本脚本主要是整理可被RT-Thread使用的Arduino库信息，一些特定型号的库（例如专门给UNO板的库）将被滤除掉
# 附带爬取这些库在github中的star数量
# 爬取网站 http://downloads.arduino.cc/libraries/library_index.json
# 更多信息：https://github.com/arduino/libraries-repository-engine
import requests
import openpyxl
